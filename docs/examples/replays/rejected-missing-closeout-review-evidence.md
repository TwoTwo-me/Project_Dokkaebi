# Rejected Replay Fixture: Missing Closeout Review Evidence

This replay fixture is rejected because Manager review and closeout evidence are
absent.

## Replay identity

- **Replay ID:** `replay-37-rejected-closeout`
...
- **Expected replay result:** reject
- **Reason:** Manager review and closeout evidence are missing.
